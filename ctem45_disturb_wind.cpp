...
int setGIStopography(ofstream &flog1, FILE *fstxt,
                     FILE *felev); /// TWC

int testEquil(void);

void updateCalibPar(tcalkey &tcal, const double &factor,
                    int &t); //// TWC
...
int main()
{
    ...
    while (xdyr > -10)
    {
        ...
        //    cout << "xdyr = " << xdyr << " " << cdyear << " " << de_startyear << " " << clm.startyr << " " <<
        //    de_nyears << endl;
        ...
        for (dm = 0; dm < CYCLE; ++dm)
        {
            ...
            tem.stepmonth(xdyr, dm, tem.intflag, tem.tol, 1, flog1);
        ...
        {
            equilsol = tem.testEquilibrium(xdyr, de_nyears, vegceq[(xdyr % de_nyears)], soilceq[(xdyr % de_nyears)],
                                           vegneq[(xdyr % de_nyears)], soilneq[(xdyr % de_nyears)]);
        }
...
void calibrate(int t)
{
    ...
    printw("AN = %1d, NF = %1d, BL = %1d, MF = %1d, RS = %1d", tem.avlnflag, tem.nfeed, tem.baseline, tem.moistlim,
           reset);
...
void displayCalibPar(tcalkey &tcal)
{
    ...
    case T_TOL:
        ...
        printw("INTEGRATOR TOLERANCE = %6.4lf ", tem.tol);
        break;

    case T_TAVG:
        move(VPARAMS_ROW, 20);

        printw("'YR' AVERAGING TIME  = %6.1lf ", tem.tauavg);
        break;

    case T_CO2:
        move(VPARAMS_ROW, 20);

        printw("CO2, PPMV            = %6.1lf ", tem.atms.getCO2LEVEL());
        break;
    ...
    case T_GDDMIN:
        ...
        printw("GDDMIN = %8.2lf                 ", tem.ag.getGDDMIN(tem.ag.cmnt));
        break;

    case T_GDDSEED:
        move(VPARAMS_ROW + 1, 20);

        printw("GDDSEED = %8.2lf                ", tem.ag.getGDDSEED(tem.ag.cmnt));
        break;

    case T_GDDHARVST:
        move(VPARAMS_ROW + 1, 20);

        printw("GDDHARVST = %8.2lf              ", tem.ag.getGDDHARVST(tem.ag.cmnt));
        break;

    case T_TKILL:
        move(VPARAMS_ROW + 1, 20);

        printw("TKILL = %6.2lf                  ", tem.ag.getTKILL(tem.ag.cmnt));
        break;
    ...
    case T_CMAX:
        ...
        printw("CMAX = %8.4lf                   ", tem.veg.getCMAX());
        break;

    case T_KRA:
        move(VPARAMS_ROW + 2, 20);

        printw("KRA = %8.6lf                    ", tem.veg.getKRA(tem.veg.cmnt));
        break;
    ...
    case T_TAULEAF:
        ...
        printw("TAULEAF = %8.4lf                ", tem.veg.getTAULEAF(tem.veg.cmnt));
        break;

    case T_TAUSTEMA:
        move(VPARAMS_ROW + 2, 20);

        printw("TAUSAPWOOD = %8.4lf             ", tem.veg.getTAUSAPWOOD(tem.veg.cmnt));
        break;

    case T_TAUSTEMI:
        move(VPARAMS_ROW + 2, 20);

        printw("TAUHEARTWOOD = %8.4lf           ", tem.veg.getTAUHEARTWOOD(tem.veg.cmnt));
        break;

    case T_TAUROOT:
        move(VPARAMS_ROW + 2, 20);

        printw("TAUROOT = %8.4lf                ", tem.veg.getTAUROOT(tem.veg.cmnt));
        break;

    case T_TAUSEED:
        move(VPARAMS_ROW + 2, 20);

        printw("TAUSEED = %8.4lf                ", tem.veg.getTAUSEED(tem.veg.cmnt));
        break;

    case T_NMAX:
        move(VPARAMS_ROW + 2, 20);

        printw("NMAX = %8.2lf                   ", tem.veg.getNMAX());
        break;

    case T_MNUP:
        move(VPARAMS_ROW + 2, 20);

        printw("MNUP = %8.4lf                   ", tem.microbe.getNUP());
        break;

    case T_CNSOL:
        move(VPARAMS_ROW + 2, 20);

        printw("CNSOIL = %8.4lf                 ", tem.microbe.getCNSOIL(tem.veg.cmnt));
        break;

    case T_CNLTR:
        move(VPARAMS_ROW + 2, 20);

        printw("CNLTR = %8.4lf                  ", tem.veg.getCNLTR(tem.veg.cmnt));
        break;

    case T_NLOSS:
        move(VPARAMS_ROW + 2, 20);

        printw("NLOSS = %8.2lf                  ", tem.soil.getNLOSS(tem.veg.cmnt));
        break;

    case T_DENITR:
        move(VPARAMS_ROW + 2, 20);

        printw("DENITR = %8.2lf                  ", tem.soil.getDENITR(tem.veg.cmnt));
        break;
    ...
    case T_SLA:
        ...
        printw("SLA = %8.4lf                    ", tem.veg.getSLA(tem.veg.cmnt));
        break;

    case T_MOPT:
        move(VPARAMS_ROW + 3, 20);

        printw("MOPT = %8.4lf                   ", tem.microbe.getMOISTOPT(tem.veg.cmnt));
        break;
    ...
    case T_GROOT:
        ...
        printw("GROOT = %8.4lf                  ", tem.veg.pen.getGROOT(tem.veg.cmnt));
        break;

    case T_KSTEM:
        move(VPARAMS_ROW + 4, 20);

        printw("KSTEM = %8.1lf                  ", tem.veg.pen.getKSTEM(tem.veg.cmnt));
        break;

    case T_CDLEAF:
        move(VPARAMS_ROW + 4, 20);

        printw("CDLEAF = %8.4lf                 ", tem.veg.pen.getCDLEAF(tem.veg.cmnt));
        break;

    case T_WLEAF:
        move(VPARAMS_ROW + 4, 20);

        printw("WLEAF = %8.4lf                  ", tem.veg.pen.getWLEAF(tem.veg.cmnt));
        break;

    case T_GSMIN:
        move(VPARAMS_ROW + 4, 20);

        printw("GSMIN = %8.4lf                  ", tem.veg.pen.getGSMIN(tem.veg.cmnt));
        break;

    case T_GSA:
        move(VPARAMS_ROW + 4, 20);

        printw("GSA= %8.4lf                     ", tem.veg.pen.getGSA(tem.veg.cmnt));
        break;

    case T_KEXT:
        move(VPARAMS_ROW + 4, 20);

        printw("KEXT = %8.4lf                   ", tem.veg.pen.getKEXT(tem.veg.cmnt));
        break;

    case T_ALBEDO:
        move(VPARAMS_ROW + 4, 20);

        printw("ALBEDO = %8.4lf                 ", tem.veg.pen.getALBEDO(tem.veg.cmnt));
        break;

    case T_LSCMIN:
        move(VPARAMS_ROW + 4, 20);

        printw("LSCMIN = %8.4lf                 ", tem.veg.pen.getLSCMIN(tem.veg.cmnt));
        break;

    case T_RHOSTEM:
        move(VPARAMS_ROW + 4, 20);

        printw("RHOSTEM = %8.4lf                ", tem.veg.pen.getRHOSTEM(tem.veg.cmnt));
        break;
...
void initializeCLMGridCell()
{
    ...
    if (0 == clm.sradflag)
    {
        ...
        tempfname << clm.igirrfname << clm.igirrend;
    ...
    if (1 == clm.cldflag)
    {
        ...
        tempfname << clm.icldsfname << clm.icldsend;
    ...
    else
    {
        ...
        tempfname << clm.inirrfname << clm.inirrend;
    ...
    if (1 == clm.parflag)
    {
        ...
        tempfname << clm.iparfname << clm.iparend;
    ...
    tempfname << clm.itairfname << clm.itairend;
    ...
    tempfname << clm.iprecfname << clm.iprecend;
    ...
    tempfname << clm.itrangefname << clm.itrangeend;
    ...
    tempfname << clm.ivprfname << clm.ivprend;
    ...
    tempfname << clm.iws10fname << clm.iws10end;
    ...
    tempfname << clm.io3fname << clm.io3end;
    ...
    tempfname << atmdep.ndepfname << atmdep.ndepend;
...
void initRun(void)
{
    ...
    flog1 << " the TEMclm model " << ((clm.sradflag == 1) ? "will" : "will not")
          << " be run for solar radiation variables " << endl;
    flog1 << ((clm.tcldsflag == 1) ? "transient " : "static ")
          << ((clm.cldflag == 1) ? "cloudiness" : "surface radiation") << " data will be used" << endl;
    if (clm.sradflag == 0)
    {
    ...
    if (clm.sradflag == 0)
    {
        if (clm.tcldsflag == 1)
        {
            ...
            flog1 << " filename for photosynthetically active radiation data input: " << clm.iparfname + clm.iparend
                  << endl;
        }
        else
        {
    ...
    if (tem.equil == 1)
    {
        flog1 << " maximum number of years for the model to run before initialization is complete: " << tem.maxyears
              << " years " << endl;
    }
...
{
    move(YRAVGS_ROW, 1);
    printw("YRVEGC = %7.1lf  | YRVEGN =  %6.2lf   | YRPLEAF =   %5.3lf | YRNIN   =  %6.3lf | YRPREC = %7.2lf | ROOTZMM "
           " = %7.2lf || AGYIELDC = %6.2lf",
           tem.veg.yrcarbon, tem.veg.yrnitrogen, tem.veg.yrpleaf, tem.soil.yrnin,
           (tem.atms.yrrain + tem.atms.yrsnowfall), tem.soil.getROOTZ() * 1000.0, tem.ag.yrformPROD1C);

    move(YRAVGS_ROW + 1, 1);
    printw("YRSOLC = %7.1lf  | YRSOLN = %6.1lf    | YRPSTEM =   %5.3lf | YRNLOST =  %6.3lf | YREET  = %7.2lf | "
           "FLDCAPMM = %7.2lf || AGYIELDN = %6.2lf",
           tem.soil.yrorgc, tem.soil.yrorgn, tem.veg.yrpsapwood, tem.soil.yrnlost, tem.soil.yreet, tem.soil.getFLDCAP(),
           tem.ag.yrformPROD1N);

    move(YRAVGS_ROW + 2, 1);
    //  printw( "INGPP  =  %7.2lf | AVALN  =    %6.4lf | YRPROOT =   %5.3lf | A->ILC  = %6.2lf  | YRWYLD = %7.2lf |
    //  WILTPTMM = %7.2lf || AGSTUBC  = %6.2lf",
    printw("INGPP  =  %7.2lf | AVALN  =    %6.4lf | YRPROOT =   %5.3lf | YRLCHDIN  = %6.2lf  | YRWYLD = %7.2lf | "
           "WILTPTMM = %7.2lf || AGSTUBC  = %6.2lf",
           //          tem.veg.yringpp, tem.soil.yravln, tem.veg.yrproot, tem.veg.yrallocilc, tem.soil.yrh2oyld,
           //          tem.soil.getWILTPT(), tem.ag.yrstubC );
           tem.veg.yringpp, tem.soil.yravln, tem.veg.yrproot, tem.soil.yrlchdin, tem.soil.yrh2oyld,
           tem.soil.getWILTPT(), tem.ag.yrstubC);

    move(YRAVGS_ROW + 3, 1);
    printw("GPP    =  %7.2lf | NRSRB  =    %6.4lf | YRSTRN  = %6.2lf  | A->ISC  = %6.2lf  | YRRAIN = %7.2lf | AWCAPMM  "
           "= %7.2lf || AGSTUBN  = %6.2lf",
           tem.veg.yrgpp, tem.veg.yrnrsorb, tem.veg.yrstructn, tem.veg.yrallocisc, tem.atms.yrrain,
           tem.soil.getAWCAPMM(), tem.ag.yrstubN);

    move(YRAVGS_ROW + 4, 1);
    printw("INNPP  =  %7.2lf | INNUP  =   %6.3lf  | LABILN  =  %5.2lf  | A->IRC  = %6.2lf  | YRSNOW = %7.2lf | YRAVLW  "
           " = %7.2lf || A->SEEDC = %6.2lf",
           tem.veg.yrinnpp, tem.veg.yrinnup, tem.veg.yrstoren, tem.veg.yrallocirc, tem.atms.yrsnowfall,
           tem.soil.yravlh2o, tem.veg.yrallocseedc);

    move(YRAVGS_ROW + 5, 1);
    printw("NPP    =  %7.2lf | NUP    =   %6.3lf  | YRVEGCN = %6.2lf  | RMLEAF  = %6.2lf  | SNWINF = %7.2lf | YRGRNDW  "
           "= %7.2lf || A->SEEDN = %6.2lf",
           tem.veg.yrnpp, tem.veg.yrnup, tem.veg.yrc2n, tem.veg.yrrmleaf, tem.soil.yrsnowinf,
           (tem.soil.yrrgrndh2o + tem.soil.yrsgrndh2o), tem.veg.yrallocseedn);

    move(YRAVGS_ROW + 6, 1);
    printw("YRLTRC =  %7.2lf | YRLTRN =   %6.3lf  | YRSOLCN =  %5.2lf  | RMSTEM  = %6.2lf  | RPERC  = %7.2lf | "
           "YRSMOIST = %7.2lf || YRPSEED = %5.3lf",
           //          tem.veg.yrltrc, tem.veg.yrltrn, tem.soil.yrc2n, tem.veg.yrrmsapwood, tem.soil.yrrperc,
           //          tem.soil.yrsmoist, tem.ag.yrgrowdd );
           tem.veg.yrltrc, tem.veg.yrltrn, tem.soil.yrc2n, tem.veg.yrrmsapwood, tem.soil.yrrperc, tem.soil.yrsmoist,
           tem.veg.yrpseed);

    move(YRAVGS_ROW + 7, 1);
    //  printw( "YRRH   =  %7.2lf | NMIN   =   %6.3lf  | YRNEP   = %6.2lf  | RMROOT  = %6.2lf  | SPERC  = %7.2lf | YRVSM
    //  = %7.2lf || YRFROST  = %5.3lf",
    printw("YRRH   =  %7.2lf | NMIN   =   %6.3lf  | YRNEP   = %6.2lf  | RMROOT  = %6.2lf  | SPERC  = %7.2lf | YRVSM    "
           "= %7.2lf || YRFROST  = %5.3lf",
           tem.microbe.yrrh, tem.microbe.yrnmin, tem.yrnep, tem.veg.yrrmroot, tem.soil.yrsperc, tem.soil.yrvsm * 100.0,
           tem.ag.yrfrost);
...
void resetInitState(void)
{
    ...
    for (dm = 0; dm < CYCLE; ++dm)
    {
        tem.veg.phenology(tem.veg.cmnt, climate[clm.I_TAIR][dm][firstyear], climate[clm.I_TAIRD][dm][firstyear],
                          climate[clm.I_TAIRN][dm][firstyear], 1.0, 1.0, 0.0);
    ...
    tem.soil.xtext(tem.veg.cmnt, tem.soil.getPCTSILT(), tem.soil.getPCTCLAY());
...
int setGIStopography(ofstream &rflog1, FILE *fstxt, FILE *felev)
{
...
void updateCalibPar(tcalkey &tcal, const double &factor, int &t)
{
    int dm;
    ...
    case T_GDDMIN:
        tem.ag.setGDDMIN((tcalvar[T_GDDMIN] * factor), tem.ag.cmnt);
        break;

    case T_GDDSEED:
        tem.ag.setGDDSEED((tcalvar[T_GDDSEED] * factor), tem.ag.cmnt);
        break;

    case T_GDDHARVST:
        tem.ag.setGDDHARVST((tcalvar[T_GDDHARVST] * factor), tem.ag.cmnt);
        break;

    case T_TKILL:
        tem.ag.setTKILL((tcalvar[T_TKILL] * factor), tem.ag.cmnt);
        break;
    ...
    case T_KRA:
        tem.veg.setKRA((tcalvar[T_KRA] * factor), tem.veg.cmnt);
        break;
    ...
    case T_TAULEAF:
        tem.veg.setTAULEAF((tcalvar[T_TAULEAF] * factor), tem.veg.cmnt);
        break;

    case T_TAUSTEMA:
        tem.veg.setTAUSAPWOOD((tcalvar[T_TAUSTEMA] * factor), tem.veg.cmnt);
        break;

    case T_TAUSTEMI:
        tem.veg.setTAUHEARTWOOD((tcalvar[T_TAUSTEMI] * factor), tem.veg.cmnt);
        break;

    case T_TAUROOT:
        tem.veg.setTAUROOT((tcalvar[T_TAUROOT] * factor), tem.veg.cmnt);
        break;

    case T_TAUSEED:
        tem.veg.setTAUSEED((tcalvar[T_TAUSEED] * factor), tem.veg.cmnt);
        break;
    ...
    case T_CNSOL:
        tem.microbe.setCNSOIL((tcalvar[T_CNSOL] * factor), tem.veg.cmnt);
        break;

    case T_CNLTR:
        tem.veg.setCNLTR((tcalvar[T_CNLTR] * factor), tem.veg.cmnt);
        break;

    case T_NLOSS:
        tem.soil.setNLOSS((tcalvar[T_NLOSS] * factor), tem.veg.cmnt);
        break;

    case T_DENITR:
        tem.soil.setDENITR((tcalvar[T_DENITR] * factor), tem.veg.cmnt);
        break;
        //// End of 19 datfile variables

    case T_SLA:
        tem.veg.setSLA((tcalvar[T_SLA] * factor), tem.veg.cmnt);
        break;

    case T_MOPT:
        tem.microbe.setMOISTOPT((tcalvar[T_MOPT] * factor), tem.veg.cmnt);
        break;

        //// End of 2 vegfile variables

    case T_GROOT:
        tem.veg.pen.setGROOT((tcalvar[T_GROOT] * factor), tem.veg.cmnt);
        break;

    case T_KSTEM:
        tem.veg.pen.setKSTEM((tcalvar[T_KSTEM] * factor), tem.veg.cmnt);
        break;

    case T_CDLEAF:
        tem.veg.pen.setCDLEAF((tcalvar[T_CDLEAF] * factor), tem.veg.cmnt);
        break;

    case T_WLEAF:
        tem.veg.pen.setWLEAF((tcalvar[T_WLEAF] * factor), tem.veg.cmnt);
        break;

    case T_GSMIN:
        tem.veg.pen.setGSMIN((tcalvar[T_GSMIN] * factor), tem.veg.cmnt);
        break;

    case T_GSA:
        tem.veg.pen.setGSA((tcalvar[T_GSA] * factor), tem.veg.cmnt);
        break;

    case T_KEXT:
        tem.veg.pen.setKEXT((tcalvar[T_KEXT] * factor), tem.veg.cmnt);
        break;

    case T_ALBEDO:
        tem.veg.pen.setALBEDO((tcalvar[T_ALBEDO] * factor), tem.veg.cmnt);
        break;

    case T_LSCMIN:
        tem.veg.pen.setLSCMIN((tcalvar[T_LSCMIN] * factor), tem.veg.cmnt);
        break;

    case T_RHOSTEM:
        tem.veg.pen.setRHOSTEM((tcalvar[T_RHOSTEM] * factor), tem.veg.cmnt);
        break;
...
void updateTCLMGridCell(const int &pdyr)
{
    ...
    for (dm = 0; dm < CYCLE; ++dm)
    {
        ...
        climate[clm.I_TAIRD][dm][pdyr] =
            climate[clm.I_TAIR][dm][pdyr] + 12.0 * climate[clm.I_TRANGE][dm][pdyr] / climate[clm.I_DAYL][dm][pdyr] *
                                                1.732 / (2.0 * 3.14159) *
                                                sin(3.14159 * climate[clm.I_DAYL][dm][pdyr] / 24.0);

        // Nighttime air temperature

        climate[clm.I_TAIRN][dm][pdyr] =
            climate[clm.I_TAIR][dm][pdyr] - 12.0 * climate[clm.I_TRANGE][dm][pdyr] /
                                                (24.0 - climate[clm.I_DAYL][dm][pdyr]) * 1.732 / (2.0 * 3.14159) *
                                                sin(3.14159 * climate[clm.I_DAYL][dm][pdyr] / 24.0);
        ...
        clm.precsplt(climate[clm.I_PREC][dm][pdyr], climate[clm.I_TAIR][dm][pdyr], climate[clm.I_RAIN][dm][pdyr],
        ...
        climate[clm.I_VPDD][dm][pdyr] =
            (10. * 0.61078 * exp((17.27 * climate[clm.I_TAIRD][dm][pdyr]) / (climate[clm.I_TAIRD][dm][pdyr] + 237.3))) -
            vprdat[dyr].mon[dm];
        ...
        climate[clm.I_VPDN][dm][pdyr] =
            (10. * 0.61078 * exp((17.27 * climate[clm.I_TAIRN][dm][pdyr]) / (climate[clm.I_TAIRN][dm][pdyr] + 237.3))) -
            vprdat[dyr].mon[dm];
