  ...
  public:
    ...
    ************************************************************** */
    ...
    int stepmonth(const int &pdyr, const int &pdm, int &intflag, const double &ptol, const int &icohort,
                  ofstream &flog1, const float &col, const float &row);

    int testEquilibrium(const int &pdyr, const int &nyears, const double &vegceq, const double &soilceq,
    ...
    inline double getPREVY(const int &i)
    {
        return prevy[i];
    }
