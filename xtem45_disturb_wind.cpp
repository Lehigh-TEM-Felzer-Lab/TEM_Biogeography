...
void initializeCLMGridCell()
{
    ...
    tempfname << telmnt[0].clm.iws10fname << telmnt[0].clm.iws10end;
...
void initRun(void)
{
    ...
    if (0 == equil)
    {
        ...
        flog1 << " initialize model using "
              << ((telmnt[0].spinflag == 0)
                      ? "equilibration to long-term average climate"
                      : ((telmnt[0].spinflag == 1) ? "equilibration then spinup" : "dynamic equilibration"))
              << endl;
...
void updateTCLMGridCell(const int &pdyr)
{
    ...
    // cout << "dyr, pdyr = " << dyr << " " << pdyr << " " << istateflag << " " << totsptime << " " <<
    // telmnt[0].spinflag << endl;
...
//  Pass disturbance information to telmnt[0]
    ...
    for (ichrt = 0; ichrt < telmnt[0].maxcohorts; ++ichrt)
    {
        ...
        cout << "lulc type = " << ichrt << " "
             << " " << telmnt[0].cohort[ichrt].cmnt << " " << telmnt[0].cohort[ichrt].agcmnt << " "
             << lulcdat[tstyr][ichrt].agstate << endl;
    }
};
...
void updateTTEMGridCell(const int &pdyr, ofstream &rflog1)
{
    ...
    ************************************************************* */
    ...
    for (ichrt = 0; ichrt < telmnt[0].maxcohorts; ++ichrt)
    {
        ...
        //  cout << "soil texture = " << ichrt << " " <<  telmnt[0].cohort[ichrt].cmnt << " " <<  telmnt[0].tem.veg.cmnt
        //  << endl;
        ...
        cout << "write output = " << telmnt[0].tem.totyr << " " << telmnt[0].wrtyr % telmnt[0].tem.diffyr << " "
             << telmnt[0].tem.startyr << " " << telmnt[0].tem.endyr << endl;
