...
class Humnact45 : public ProcessXML45
{
  ...
  public:
    ...
    ************************************************************** */
    ...
    void conversion(const int &pdcmnt, const double &slashc, const double &slashn, const double &vegc,
                    const double &vstrn, const double &vston, const double &solc, const double &soiln,
                    const double &cwdloss, const int &time);

    void createWoodProducts(const int &outyr, const double &stemc, const double &stemn);

    void decayProducts(void);

    void frostDamage(const double &vegc, const double &vegn);

    void getecd(const string &ecd);

    void grazing(const double &leafc, const double &sapc, const double &heartc, const double &labilec,
                 const double &leafn, const double &sapn, const double &heartn, const double &labilen,
                 const double &rootc);

    void harvest(const int &pdm, const double &seedc, const double &seedn, const double &vegc, const double &vegn);
    ...
    void standingdead(const int &pdcmnt, const double &slashc, const double &slashn, const double &vegc,
                      const double &vstrn, const double &cwdloss);

    void updatestanddead(const int &pdyr, const double &rhmoist, const double &dq10, const double &cnltr);
    ...
    inline double getANIMALRESP(void)
    {
        return animalresp;
    }
    ...
    inline double getCLIPPINGS(void)
    {
        return clippings;
    }
    ...
    inline void setCROPSEEDC(const double &pcropseedc, const int &pcmnt)
    {
    ...
    inline void setCROPSEEDSTON(const double &pcropseedston, const int &pcmnt)
    {
    ...
    inline void setCROPSEEDSTRN(const double &pcropseedstrn, const int &pcmnt)
    {
    ...
    inline double getCROPTOPT(void)
    {
        return croptopt;
    }
    ...
    inline int getFRI(void)
    {
        return FRI;
    }

    inline void setFRI(const int &pfri)
    {
        FRI = pfri;
    }
    ...
    inline int getFROSTFLAG(void)
    {
        return frostflag;
    }

    inline void setFROSTFLAG(const int &pfrostflag)
    {
        frostflag = pfrostflag;
    }
    ...
    inline void setGDDMIN(const double &pgddmin, const int &pcmnt)
    {
    ...
    inline void setGDDSEED(const double &pgddseed, const int &pcmnt)
    {
    ...
    inline void setGDDHARVST(const double &pgddharvst, const int &pcmnt)
    {
    ...
    inline void setHARVSTC(const double &pharvstC, const int &pcmnt)
    {
    ...
    inline void setHARVSTN(const double &pharvstN, const int &pcmnt)
    {
    ...
    inline double getIMMBADD(void)
    {
        return immbadd;
    }

    inline void setIMMBADD(const double &pimmbadd)
    {
        immbadd = pimmbadd;
    }
    ...
    inline void setINITPROD1C(const double &pinprod1c, const int &pdm)
    {
    ...
    inline void setINITPROD1N(const double &pinprod1n, const int &pdm)
    {
    ...
    inline void setINITPROD10C(const double &pinprod10c, const int &i)
    {
    ...
    inline void setINITPROD10N(const double &pinprod10n, const int &i)
    {
    ...
    inline void setINITPROD100C(const double &pinprod100c, const int &i)
    {
    ...
    inline void setINITPROD100N(const double &pinprod100n, const int &i)
    {
    ...
    inline double getKD(void)
    {
        return kd;
    }

    inline void setKD(const double &pkd)
    {
        kd = pkd;
    }
    ...
    inline double getNATSEEDC(void)
    {
        return natseedC;
    }
    ...
    inline void setNSRETCONV(const double &pnsretconv, const int &pcmnt)
    {
    ...
    inline double getNSRETENT(void)
    {
        return nsretent;
    }
    ...
    inline void setNVRETCONV(const double &pnvretconv, const int &pcmnt)
    {
    ...
    inline double getNVRETENT(void)
    {
        return nvretent;
    }
    ...
    inline double getPROD1N(void)
    {
        return PROD1.nitrogen;
    }

    // PROD10.carbon ******************************************

    inline double getPROD10C(void)
    {
        return PROD10.carbon;
    }
    ...
    inline double getPROD10PAR(void)
    {
        return prod10par;
    }
    ...
    inline double getPROD100PAR(void)
    {
        return prod100par;
    }
    ...
    inline int getPRODUCTYEAR(void)
    {
        return productYear;
    }
    ...
    inline double getPRVCROPNPP(void)
    {
        return prvcropnpp;
    }
    ...
    inline void setRESIDUEC(const double &presidueC, const int &pcmnt)
    {
    ...
    inline void setRESIDUEN(const double &presidueN, const int &pcmnt)
    {
    ...
    inline double getSCONVERT(void)
    {
        return sconvert;
    }
    ...
    inline double getSLASHN(void)
    {
        return slash.nitrogen;
    }
    ...
    inline double getSLASHPAR(void)
    {
        return slashpar;
    }
    ...
    inline void setTILLFACTOR(const double &ptillfact, const int &pcmnt)
    {
    ...
    inline void setTKILL(const double &ptkill, const int &pcmnt)
    {
        tkill[pcmnt] = ptkill;
    }
    ...
    inline double getVCONVERT(void)
    {
        return vconvert;
    }
