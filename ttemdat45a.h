...
class Temdat45
{
  ...
  public:
    ...
    ************************************************************* */
    ...
    void out(ofstream &ofile, const float &col, const float &row, const string &varname, const int &icohort,
    ...
    void outdel(ofstream &ofile, const float &col, const float &row, const string &varname, const int &icohort,
                const int &standage, const int &potveg, const int &currentveg, const int &subtype, const int &cmnt,
                const double &psiplusc, const int &qlcon, const long &carea, const long &subarea, const int &year,
                double mon[CYCLE], const string &region);

    void pctout(ofstream &ofile, const float &col, const float &row, const string &varname, const int &icohort,
                const int &standage, const int &potveg, const int &currentveg, const int &subtype, const int &cmnt,
                const double &psiplusc, const int &qlcon, const long &carea, const long &subarea, const int &year,
                double mon[CYCLE], const string &region);

    void poutdel(ofstream &ofile, const float &col, const float &row, const string &varname, const int &icohort,
                 const int &standage, const int &potveg, const int &currentveg, const int &subtype, const int &cmnt,
                 const double &psiplusc, const int &qlcon, const long &carea, const long &subarea, const int &year,
                 double mon[CYCLE], const string &region);
