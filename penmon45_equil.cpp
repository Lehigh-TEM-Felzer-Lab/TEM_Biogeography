...
double Penmon45::gcpet(const int &pdcmnt, const int &dm, const double &lai, const double &gpp, const double &rcanmm,
                       const double &vpr, const double &vpd, const double &co2, const double &pdayl)
...
void Penmon45::hydraulics(const int &pdcmnt, const int &phen, const double &lai, const double &psla,
                          const double &stemc, const double &rootc, const double &availh2o, const double &awcapmm,
                          const double &prec)
...
double Penmon45::shuttlewallace(const int &pdcmnt, const double &nirr, const double &lwout, const double &lai,
                                const double &tmean, const double &vpd, const int &dm, const double &gc,
                                const double &snowcover, const double &etimes, const double &precip,
                                const double &esoilmmmo, const double &elev)

{
    ...
    */
    ...
    double ETpt;   // evaporation rate mm h2o month^-1
    double ETeq;   // equilibrium evaporation rate
    double G;      // soil heat flux (storage)
    double ETpt_W; // actual evapotranspiration rate Wm^2
    ...
    */
    ...
    return etsw; // Final Evapotranspiration
};
...
double Penmon45::actevap(const int &pdcmnt, const double &nirr, const double &lwout, const double &lai,
                         const double &tmean, const double &vpd, const int &dm, const double &gc,
                         const double &snowcover, const double &etimes, const double &precip, const double &esoilmmmo,
                         const double &elev)

{
    ...
    /*
        ...
        Calculating actual evaporation using Penman–Monteith (P–M, Monteith, 1965) equations
...
/* *************************************************************
************************************************************* */
double Penmon45::potevap(const int &pdcmnt, const double &nirr, const double &lwout, const double &lai,
                         const double &tmean, const double &vpd, const int &dm, const double &gc,
                         const double &snowcover, const double &etimes, const double &precip, const double &esoilmmmo,
                         const double &elev)

{
    ...
    /*
        ...
        Calculating potential evaporation  using Penman–Monteith (P–M, Monteith, 1965) equations
...
/* *************************************************************
************************************************************* */
double Penmon45::watev(const double &nirr, const double &lwout, const double &tmean, const double &vpd,
                       const double &wind, const double &rrun, const double &srun, const int &dm)
...
void Penmon45::getecd(const string &ecd)
{
    ...
    for (dcmnt = 1; dcmnt < MAXCMNT; ++dcmnt)
    {
        ...
        cdleaf[comtype] = getXMLcmntArrayDouble(infile, "gcECD", "cdleaf", comtype);

        wleaf[comtype] = getXMLcmntArrayDouble(infile, "gcECD", "wleaf", comtype);

        gsa[comtype] = getXMLcmntArrayDouble(infile, "gcECD", "gsa", comtype);

        gsmin[comtype] = getXMLcmntArrayDouble(infile, "gcECD", "gsmin", comtype);

        kext[comtype] = getXMLcmntArrayDouble(infile, "gcECD", "kext", comtype);

        albedo[comtype] = getXMLcmntArrayDouble(infile, "gcECD", "albedo", comtype);

        lscmin[comtype] = getXMLcmntArrayDouble(infile, "gcECD", "lscmin", comtype);

        groot[comtype] = getXMLcmntArrayDouble(infile, "gcECD", "groot", comtype);

        kstem[comtype] = getXMLcmntArrayDouble(infile, "gcECD", "kstem", comtype);

        rhostem[comtype] = getXMLcmntArrayDouble(infile, "gcECD", "rhostem", comtype);
