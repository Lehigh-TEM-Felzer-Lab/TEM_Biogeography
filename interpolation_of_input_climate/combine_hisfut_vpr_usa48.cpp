...
{	
        ...
        FILE* tairhis;
        tairhis = fopen("/m2/partition2/tem/IDL/millennial/vpr_millennial_1750_2014.usa48", "r");
        if (!tairhis){
        ...
        FILE* tairfut;
        tairfut = fopen("/m2/partition2/tem/IDL/millennial/vpr_ssp370_2015_2099_tem.usa48", "r");
        if (!tairfut){
	...
	sprintf(file,"vpr_ssp370_1750_2099_tem.usa48");
	ofstream fout; 
    ...
    for(m=1750; m<2015; m++)
    {
       ...
       fout << setprecision(1) << xlonp << "," << ylatp << ", " << "VPRPRESS" << " ," <<
