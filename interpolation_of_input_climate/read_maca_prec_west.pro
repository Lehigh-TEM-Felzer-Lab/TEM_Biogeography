PRO read_maca_prec_west
  ...
  fileid = ncdf_open("/m8/kodero/raw_data/MACA_DATA/agg_macav2metdata_pr_HadGEM2-CC365_r1i1p1_rcp85_2006_2099_CONUS_monthly.nc")
...
close,2
   ...
   openw, 1,width=1000, "/m8/kodero/runs/united_kingdom/climate/pr_HadGEM2-CC365_rcp85_2006_2099.csv"
...
;
   ...
   val(i,mon,yrar) = 0.0
   if(precipitation(lonval,latval,t+mon) gt -9999 and lonval lt 595 and latval lt 584) then begin
