...
int Elevdat45::getdel(FILE *infile)
{
    ...
    elvend = fscanf(infile, "%f,%f, %s ,%ld,%lf, %s", &col, &row, tmpvarname, &carea, &elev, tmpcontnent);
...
void Elevdat45::out(ofstream &ofile, const float &col, const float &row, const string &varname, const long &carea,
                    const double &elev, const string &contnent)
{
...
void Elevdat45::outdel(ofstream &ofile, const float &col, const float &row, const string &varname, const long &carea,
                       const double &elev, const string &contnent)
{
