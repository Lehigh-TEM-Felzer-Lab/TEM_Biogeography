...
mean_monthly_moisture_stress = dependencies.pd.read_csv(
    mean_monthly_moisture_stress_path, names=mean_monthly_moisture_stress_columns
)
...
mean_summer_moisture_stress = dependencies.pd.read_csv(
    mean_summer_moisture_stress_path, names=mean_summer_moisture_stress_columns
)
