...
class Tmcrb45 : public ProcessXML45
{
  ...
  public:
    ...
    ************************************************************** */
    ...
    void setDQ10LaRS(const int &pdcmnt, const double &ptair);

    double setDQ10LT(const int &pdcmnt, const double &ptair, const double &ptopt);

    double setRHMOIST(const int &pdcmnt, const double &pctfldcap, const double &pctwiltpt, const double &pctpor,
                      const double &vsm, const int &moistlim);

    void showecd(const int &pdcmnt);

    void updateDynamics(const int &pcmnt, const double &pctfldcap, const double &pctwiltpt, const double &pctpor,
    ...
    double yrkd(const int &nfeed, const double &yrltrc, const double &yrltrn, const int &pdcmnt);
    ...
    inline void setCNSOIL(const double &pcnsoil, const int &pcmnt)
    {
    ...
    inline double getDOCDON(const int &pcmnt)
    {
        return docdon[pcmnt];
    }
    ...
    inline void setKDB(const double &pkdb, const int &pcmnt)
    {
        kdb[pcmnt] = pkdb;
    }
    ...
    inline double getKDC(void)
    {
        return kdc;
    }

    inline void setKDC(const double &pkdc)
    {
        kdc = pkdc;
    }
    ...
    inline void setKN2(const double &pkn2, const int &pcmnt)
    {
        kn2[pcmnt] = pkn2;
    }
    ...
    inline void setLCCLNC(const double &plcclnc, const int &pcmnt)
    {
    ...
    inline void setMOISTMAX(const double &pmoistmax, const int &pcmnt)
    {
    ...
    inline void setMOISTMIN(const double &pmoistmin, const int &pcmnt)
    {
    ...
    inline void setMOISTOPT(const double &pmoistopt, const int &pcmnt)
    {
    ...
    inline void setNUPA(const double &pnupa, const int &pcmnt)
    {
        nupa[pcmnt] = pnupa;
    }
    ...
    inline void setNUPB(const double &pnupb, const int &pcmnt)
    {
        nupb[pcmnt] = pnupb;
    }
    ...
    inline void setPROPFTOS(const double &ppropftos, const int &pcmnt)
    {
    ...
    inline void setRHQ10(const double &prhq10, const int &pcmnt)
    {
        rhq10[pcmnt] = prhq10;
    }
  ...
  private:
    ...
    ************************************************************** */
    ...
    double nminxclm(const int &pdcmnt, const double &soilh2o, const double &soilorgc, const double &soilorgn,
                    const double &availn, const double &ksoil, const int &nopen, const double &immbadd,
                    const double &volac, const double &volan);

    double rhxclm(const double &soilorgc, const double &pdq10, const double &moist, const double &rltrc,
                  const double &volac);
