...
{	
        ...
        FILE* crutair;
        crutair = fopen("/m2/partition2/tem/CRU4.04/cru_ts4.04.1901.2014lf.cld.dat_usa48.csv", "r");
        if (!crutair){
       ...
       FILE* cruarea;
        ...
        sprintf(file,"clds_future_cesm_year.usa48");
        ifstream ffut;
	...
	sprintf(file,"clds_ssp370_2015_2099_tem.usa48");
	ofstream fout; 
