...
//        crutair = fopen("/share/partition2/tem/IDL/millennial/tas_millennial_1750_2014.usa48", "r");
        crutair = fopen("/share/partition2/tem/IDL/millennial/dtr_millennial_1750_2014.usa48", "r");
        if (!crutair){
	...
	ifstream fcru;
//	fcru.open("/share/partition2/tem/CRU4.04/cru2tmpbl.usa48", ios::in);
	fcru.open("/share/partition2/tem/CRU4.04/cru2dtrbl.usa48", ios::in);
	...
	if (!fcru){
        ...
        ifstream fgmet;
//        fgmet.open("/share/partition2/climate/lehigh_river/gridmet/gridmet_bias_us_fillin.txt", ios::in);
        fgmet.open("/share/partition2/climate/lehigh_river/gridmet/gridmet_bias_us_dtr.txt", ios::in);
	...
	ofstream fout; 
//	fout.open("tas_gridmetcor.usa48", ios::out);
	fout.open("dtr_gridmetcor.usa48", ios::out);
	fout.precision(1);
    ...
    for(m=1750; m<2015; m++)
    {
       ...
       fout << setprecision(1) << clmdat.col << "," << clmdat.row << ", " << "DTAIRRNG" << " ," <<
