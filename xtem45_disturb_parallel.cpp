...
void updateTTEMGridCell(const int &pdyr, ofstream &flog1);
...
int main()
{
    ...
    elmnt.show(flog1, telmnt[0].col, telmnt[0].row, telmnt[0].tem.totyr, telmnt[0].tem.inittol,
    ...
    if (1 == telmnt[0].lcluc.tlulcflag)
    {
        for (i = 0; i < (startval); ++i)
        {
            for (xdyr = 0; xdyr < (telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1); ++xdyr)
            {
                ...
                //	  if(xdyr == 1 && i == 0) {cout << "mxcohort = " << i <<  " " << xdyr << " " << mxcohrtdat[xdyr].row
                //<<  " " << mxcohrtdat[xdyr].col << " " <<  mxtot[xdyr][i] << endl;}
            }
        }
    }
    else
    ...
    //  cout << "diag = " << tairdat[transtime].row << " " << lulcdat[telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr +
    //  1][0].row << " "
    //<< mxcohrtdat[telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1].row << endl;

    //  cout << "diag = " << tairdat[transtime].col << " " << lulcdat[telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr +
    //  1][0].col << " " << mxcohrtdat[telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1].col << endl;
    ...
    while (grdcnt < mxnumgrid && 0 == fatalerr) // Grid cell loop
    {
        ...
        for (xdyr = 0; xdyr < RTIME; ++xdyr)
        {
            ...
            {
                if ((1 == spinoutfg && telmnt[0].year < telmnt[0].clm.startyr) ||
                    (2 == spinoutfg && telmnt[0].year >= (telmnt[0].clm.startyr - spinoutyrs)) ||
                    (telmnt[0].year >= telmnt[0].clm.startyr))
                {
                    ...
                    telmnt[0].atmswritepred(fclmpred, xdyr, clmpredmap, telmnt[0].natmspred);
                }
            }
        ...
        elmnt.show(flog1, telmnt[0].col, telmnt[0].row, telmnt[0].tem.totyr, telmnt[0].tem.tol,
                   telmnt[0].tem.veg.getERRCNT());
...
void initializeCLMGridCell()
{
    ...
    if (0 == telmnt[0].clm.sradflag)
    {
        ...
        tempfname << telmnt[0].clm.igirrfname << telmnt[0].clm.igirrend;
    ...
    if (1 == telmnt[0].clm.cldflag)
    {
        ...
        tempfname << telmnt[0].clm.icldsfname << telmnt[0].clm.icldsend;
    ...
    else
    {
        ...
        tempfname << telmnt[0].clm.inirrfname << telmnt[0].clm.inirrend;
    ...
    if (1 == telmnt[0].clm.parflag)
    {
        ...
        tempfname << telmnt[0].clm.iparfname << telmnt[0].clm.iparend;
    ...
    tempfname << telmnt[0].clm.itairfname << telmnt[0].clm.itairend;
    ...
    tempfname << telmnt[0].clm.iprecfname << telmnt[0].clm.iprecend;
    ...
    tempfname << telmnt[0].clm.itrangefname << telmnt[0].clm.itrangeend;
    ...
    tempfname << telmnt[0].clm.ivprfname << telmnt[0].clm.ivprend;
    ...
    tempfname << telmnt[0].clm.io3fname << telmnt[0].clm.io3end;
    ...
    tempfname << telmnt[0].atmdep.ndepfname << telmnt[0].atmdep.ndepend;
...
void initializeLCLUCGridCell(void)
{
    ...
    tempfname << telmnt[0].lcluc.imxcohrtfname << telmnt[0].lcluc.imxcohrtend;
    ...
    tempfname << telmnt[0].lcluc.ilulcfname << telmnt[0].lcluc.ilulcend;
    ...
    tempfname << telmnt[0].disturb.istormfname << telmnt[0].disturb.istormend;
    ...
    tempfname << telmnt[0].disturb.ihurrfname << telmnt[0].disturb.ihurrend;
...
void initializeTEMGridCell(void)
{
    ...
    ************************************************************* */
    ...
    for (ichrt = 0; ichrt < telmnt[0].maxcohorts; ++ichrt)
    {
        ...
        {
            telmnt[0].setTEMequilState(flog1, equil, totsptime, ichrt, ftempred, tempredmap, spinoutfg);
            //
            ...
            if (1 == equil)
            {
                telmnt[0].temwritepred(ftempred, tempredmap, dyr, ichrt, telmnt[0].ntempred, spinoutfg, 0);
            }
...
void initRun(void)
{
    ...
    if (0 == equil)
    {
        ...
        flog1 << " initialize model using "
              << ((spinflag == 0) ? "equilibration to long-term average climate"
                                  : ((spinflag == 1) ? "equilibration then spinup" : "dynamic equilibration"))
              << endl;
    ...
    flog1 << " grid cells are located in input files by "
          << ((telmnt[0].lonlatflag == 0) ? "row/colum" : "longitude/latitude") << endl;
    ...
    flog1 << " the model will start " << ((elmnt.strtflag == 1) ? "at the beginning of" : "partway through")
          << " the GIS files " << endl;
    ...
    flog1 << " the model will end " << ((elmnt.endflag == 1) ? "at the end of" : "partway through") << " the GIS files "
          << endl;
    ...
    flog1 << " the TEMclm model " << ((telmnt[0].clm.sradflag == 1) ? "will" : "will not")
          << " be run for solar radiation variables " << endl;
    flog1 << ((telmnt[0].clm.tcldsflag == 1) ? "transient " : "static ")
          << ((telmnt[0].clm.cldflag == 1) ? "cloudiness" : "surface radiation") << " data will be used" << endl;
    if (telmnt[0].clm.sradflag == 0)
    {
        flog1 << " spatially explicit PAR data " << ((telmnt[0].clm.parflag == 1) ? "will" : "will not") << " be used "
              << endl;
    }
    ...
    if ((telmnt[0].clm.cldflag == 1) && (telmnt[0].clm.sradflag == 1))
    {
        if (telmnt[0].clm.tcldsflag == 1)
        {
            flog1 << " filename for cloudiness data input: " << telmnt[0].clm.icldsfname + telmnt[0].clm.icldsend
                  << endl;
        }
        else
        {
    ...
    if ((telmnt[0].clm.cldflag == 0) && (telmnt[0].clm.sradflag == 1))
    {
        if (telmnt[0].clm.tcldsflag == 1)
        {
            flog1 << " filename for solar radiation data input: " << telmnt[0].clm.inirrfname + telmnt[0].clm.inirrend
                  << endl;
        }
        else
        {
    ...
    if (telmnt[0].clm.sradflag == 0)
    {
        if (telmnt[0].clm.tcldsflag == 1)
        {
            flog1 << " filename for top-of-atmosphere radiation data input: "
                  << telmnt[0].clm.igirrfname + telmnt[0].clm.igirrend << endl;
            flog1 << " filename for surface radiation data input: " << telmnt[0].clm.inirrfname + telmnt[0].clm.inirrend
                  << endl;
            flog1 << " filename for photosynthetically active radiation data input: "
                  << telmnt[0].clm.iparfname + telmnt[0].clm.iparend << endl;
        }
        else
        {
            ...
            flog1 << " filename for photosynthetically active radiation data input: " << telmnt[0].clm.iparfname
                  << endl;
        }
    }
    ...
    flog1 << " file describing number of cohorts in each grid cell: "
          << telmnt[0].lcluc.imxcohrtfname + telmnt[0].lcluc.imxcohrtend << endl;
    ...
    flog1 << " file describing land use cover and change in each cohort of each grid cell: "
          << telmnt[0].lcluc.ilulcfname + telmnt[0].lcluc.ilulcend << endl;
    ...
    flog1 << " file describing tropical storms for each grid cell: "
          << telmnt[0].disturb.istormfname + telmnt[0].disturb.istormend << endl;
    ...
    flog1 << " file describing hurricanes for each grid cell: "
          << telmnt[0].disturb.ihurrfname + telmnt[0].disturb.ihurrend << endl;
    ...
    if (1 == temflag)
    {
        ...
        flog1 << " " << ((telmnt[0].tem.avlnflag == 1) ? "allowing" : "not allowing") << " available N to fluctuate "
              << endl;
        ...
        flog1 << " " << ((telmnt[0].tem.baseline == 1) ? "solving" : "not solving") << " for baseline soil nitrogen"
              << endl;
        ...
        flog1 << " decomposition " << ((telmnt[0].tem.rheqflag == 1) ? "must" : "is not required to") << " equilibrate "
              << endl;
        ...
        flog1 << " maximum number of years for the model to run before initialization is complete: "
              << telmnt[0].tem.maxyears << " years " << endl;
        ...
        flog1 << " factor for changing relative c:n per change in co2 concentration: " << telmnt[0].tem.veg.getDC2N()
              << endl;
        ...
        for (icmnt = 0; icmnt < numcmnt; ++icmnt)
        {
            ...
            datfilenames =
                datfilenames.substr(datfilenames.find(",") + 1, (datfilenames.length() - datfilenames.find(",") - 1));
        ...
        for (i = 0; i < telmnt[0].ntempred; ++i)
        {
            ...
            temoutfiles =
                temoutfiles.substr(temoutfiles.find(",") + 1, (temoutfiles.length() - temoutfiles.find(",") - 1));
        ...
        if (telmnt[0].tem.predflag > 0)
        {
            flog1 << " output from spinup period " << ((spinoutfg == 1) ? "will" : "will not be") << " written "
                  << endl;
        }
        ...
        flog1 << " input state ( 0 -> require initizlization; 1 -> file input at equilibrium; 2 -> file input for "
                 "specific year) "
              << istateflag << endl;
        ...
        flog1 << " output state ( 0 -> do not write TEMSTATE file; 1-> save TEMSTATE at equilibrium; 2 -> save "
                 "TEMSTATE at a specific year) "
              << ostateflag << endl;
        string startval_str = static_cast<ostringstream *>(&(ostringstream() << startval))->str();
...
void updateTCLMGridCell(const int &pdyr)
{
    ...
    if (0 == pdyr)
    {
        ...
        if (0 == telmnt[0].clm.sradflag)
        {
            fatalerr = telmnt[0].coregerr(flog1, SRADname, telmnt[0].col, telmnt[0].row, "GIRR", girrdat[0].col,
                                          girrdat[0].row);
        ...
        {
            fatalerr =
                telmnt[0].coregerr(flog1, SRADname, telmnt[0].col, telmnt[0].row, "PAR", pardat[0].col, pardat[0].row);
        ...
        fatalerr =
            telmnt[0].coregerr(flog1, SRADname, telmnt[0].col, telmnt[0].row, "TAIR", tairdat[0].col, tairdat[0].row);
        ...
        fatalerr =
            telmnt[0].coregerr(flog1, SRADname, telmnt[0].col, telmnt[0].row, "PREC", precdat[0].col, precdat[0].row);
        ...
        fatalerr = telmnt[0].coregerr(flog1, SRADname, telmnt[0].col, telmnt[0].row, "TRANGE", trangedat[0].col,
                                      trangedat[0].row);
        ...
        fatalerr =
            telmnt[0].coregerr(flog1, SRADname, telmnt[0].col, telmnt[0].row, "VPD", vprdat[0].col, vprdat[0].row);
        ...
        fatalerr =
            telmnt[0].coregerr(flog1, SRADname, telmnt[0].col, telmnt[0].row, "AOT40", o3dat[0].col, o3dat[0].row);
        ...
        if (1 == telmnt[0].clm.tndepflag)
        {
            for (dyr = 0; dyr < (transtime); ++dyr)
            {
                ...
                //   cout << "ndepdat = " << dyr << " " << ndepdat[dyr].col <<  " " << ndepdat[dyr].row << " " <<
                //   ndepdat[dyr].adepval << endl;
            }
        }
        else
        {
        ...
        //
        fatalerr =
            telmnt[0].coregerr(flog1, "Climate", telmnt[0].col, telmnt[0].row, "NDEP", ndepdat[0].col, ndepdat[0].row);
        ...
        fatalerr =
            telmnt[0].coregerr(flog1, SRADname, telmnt[0].col, telmnt[0].row, "WS10", ws10dat[0].col, ws10dat[0].row);
    ...
    if (1 == telmnt[0].clm.tco2flag && dyr > 0)
    {
        ...
        else
        {
            for (dm = 0; dm < CYCLE; ++dm)
            {
                if (dm < 6)
                {
                    telmnt[0].climate[telmnt[0].clm.I_CO2][dm][pdyr] =
                        co2dat[dyr - 1].mco2 + ((dm + 6) * (co2dat[dyr].mco2 - co2dat[dyr - 1].mco2) / (double)CYCLE);
                }
                else
                {
                    if (dyr == transtime)
                    ...
                    telmnt[0].climate[telmnt[0].clm.I_CO2][dm][pdyr] =
                        co2dat[dyr].mco2 + ((dm - 6) * (co2dat[dyr + 1].mco2 - co2dat[dyr].mco2) / (double)CYCLE);
                }
            }
        }
    ...
    for (dm = 0; dm < CYCLE; ++dm)
    {
        ...
        telmnt[0].climate[telmnt[0].clm.I_TAIRD][dm][pdyr] =
            telmnt[0].climate[telmnt[0].clm.I_TAIR][dm][pdyr] +
            12.0 * telmnt[0].climate[telmnt[0].clm.I_TRANGE][dm][pdyr] /
                telmnt[0].climate[telmnt[0].clm.I_DAYL][dm][pdyr] * 1.732 / (2.0 * 3.14159) *
                sin(3.14159 * telmnt[0].climate[telmnt[0].clm.I_DAYL][dm][pdyr] / 24.0);

        // cout << "taird = " << dm << " " << pdyr << " " << telmnt[0].climate[telmnt[0].clm.I_TAIRD][dm][pdyr] << " "
        // << telmnt[0].climate[telmnt[0].clm.I_TAIR][dm][pdyr] << " " <<
        // telmnt[0].climate[telmnt[0].clm.I_TRANGE][dm][pdyr] << " " <<
        // telmnt[0].climate[telmnt[0].clm.I_DAYL][dm][pdyr] << endl;

        //    #ifdef DEBUGX
        //      cout << " sin(1.57) test " << sin(1.57) << endl;
        //      printf( " tair = %8.21f, trange = %8.21f, taird = %8.21f ",
        //      telmnt[0].climate[telmnt[0].clm.I_TAIR][dm][pdyr],
        //              telmnt[0].climate[telmnt[0].clm.I_TRANGE][dm][pdyr],
        //              telmnt[0].climate[telmnt[0].clm.I_TAIRD][dm][pdyr] );
        //      cout << endl;
        ...
        telmnt[0].climate[telmnt[0].clm.I_TAIRN][dm][pdyr] =
            telmnt[0].climate[telmnt[0].clm.I_TAIR][dm][pdyr] -
            12.0 * telmnt[0].climate[telmnt[0].clm.I_TRANGE][dm][pdyr] /
                (24.0 - telmnt[0].climate[telmnt[0].clm.I_DAYL][dm][pdyr]) * 1.732 / (2.0 * 3.14159) *
                sin(3.14159 * telmnt[0].climate[telmnt[0].clm.I_DAYL][dm][pdyr] / 24.0);
        ...
        telmnt[0].clm.precsplt(
            telmnt[0].climate[telmnt[0].clm.I_PREC][dm][pdyr], telmnt[0].climate[telmnt[0].clm.I_TAIR][dm][pdyr],
            telmnt[0].climate[telmnt[0].clm.I_RAIN][dm][pdyr], telmnt[0].climate[telmnt[0].clm.I_SNWFAL][dm][pdyr]);
        ...
        telmnt[0].climate[telmnt[0].clm.I_VPDD][dm][pdyr] =
            (10. * 0.61078 *
             exp((17.27 * telmnt[0].climate[telmnt[0].clm.I_TAIRD][dm][pdyr]) /
                 (telmnt[0].climate[telmnt[0].clm.I_TAIRD][dm][pdyr] + 237.3))) -
            vprdat[dyr].mon[dm];
        ...
        telmnt[0].climate[telmnt[0].clm.I_VPDN][dm][pdyr] =
            (10. * 0.61078 *
             exp((17.27 * telmnt[0].climate[telmnt[0].clm.I_TAIRN][dm][pdyr]) /
                 (telmnt[0].climate[telmnt[0].clm.I_TAIRN][dm][pdyr] + 237.3))) -
            vprdat[dyr].mon[dm];
    ...
    if (1 == telmnt[0].clm.sradflag)
    {
        ...
        for (dm = 0; dm < CYCLE; ++dm)
        {
            telmnt[0].climate[telmnt[0].clm.I_GIRR][dm][pdyr] = telmnt[0].clm.xgirr(lat, dm, telmnt[0].clm.yrsumday);
        }
    }
    else
    {
    ...
    for (dm = 0; dm < CYCLE; ++dm)
    {
        if (1 == telmnt[0].clm.cldflag)
        {
            ...
            telmnt[0].climate[telmnt[0].clm.I_NIRR][dm][pdyr] = telmnt[0].clm.xnirr(
                telmnt[0].climate[telmnt[0].clm.I_CLDS][dm][pdyr], telmnt[0].climate[telmnt[0].clm.I_GIRR][dm][pdyr]);
        }
        else
        {
            telmnt[0].climate[telmnt[0].clm.I_NIRR][dm][pdyr] = nirrdat[dyr].mon[dm] * Watts2cal;

            telmnt[0].climate[telmnt[0].clm.I_CLDS][dm][pdyr] = telmnt[0].clm.mkclds(
                telmnt[0].climate[telmnt[0].clm.I_GIRR][dm][pdyr], telmnt[0].climate[telmnt[0].clm.I_NIRR][dm][pdyr]);
        }

        if (0 == telmnt[0].clm.parflag)
        {

            telmnt[0].climate[telmnt[0].clm.I_PAR][dm][pdyr] = telmnt[0].clm.xpar(
                telmnt[0].climate[telmnt[0].clm.I_CLDS][dm][pdyr], telmnt[0].climate[telmnt[0].clm.I_NIRR][dm][pdyr]);
        }
        else
        {
    ...
    if (pdyr == 0)
    {
        ...
        telmnt[0].tem.veg.phenology(telmnt[0].tem.veg.cmnt, telmnt[0].climate[telmnt[0].clm.I_TAIR][dm][0],
                                    telmnt[0].climate[telmnt[0].clm.I_TAIRD][dm][0],
                                    telmnt[0].climate[telmnt[0].clm.I_TAIRN][dm][0], 1.0, 1.0, 0.0);
...
void updateTLCLUCGridCell(const int &pdyr)
{
    ...
    if (0 == pdyr)
    {
        ...
        if (1 == telmnt[0].lcluc.tlulcflag)
        {
            for (dyr = 0; dyr < (transtime); ++dyr)
            {
                if (dyr <= telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1)
                {
                    ...
                    fatalerr = telmnt[0].coregerr(flog1, "Climate", telmnt[0].col, telmnt[0].row, "MAXCOHORTS",
                                                  mxcohrtdat[dyr].col, mxcohrtdat[dyr].row);
                ...
                else
                {
                    ...
                    mxcohrtdat[dyr].year =
                        telmnt[0].lcluc.lastyr + (dyr - (telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1));
        ...
        else // 0 == telmnt[0].lcluc.tlulcflag
        {
            ...
            fatalerr = telmnt[0].coregerr(flog1, "Climate", telmnt[0].col, telmnt[0].row, "MAXCOHORTS",
                                          mxcohrtdat[0].col, mxcohrtdat[0].row);
        ...
        fatalerr = telmnt[0].coregerr(flog1, "Climate", telmnt[0].col, telmnt[0].row, "STORMS", stormdat[0].col,
                                      stormdat[0].row);
        ...
        // Check data for spatial coregistration error
        fatalerr = telmnt[0].coregerr(flog1, "Climate", telmnt[0].col, telmnt[0].row, "HURRICANES", hurrdat[0].col,
                                      hurrdat[0].row);
            ...
            for (dyr = 0; dyr < (transtime); ++dyr)
            {
                for (ichrt = 0; ichrt < mxcohrtdat[dyr].total; ++ichrt)
                {
                    if (dyr <= telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1)
                    {
                        ...
                        fatalerr = telmnt[0].coregerr(flog1, "Climate", telmnt[0].col, telmnt[0].row, "LULC",
                                                      lulcdat[dyr][ichrt].col, lulcdat[dyr][ichrt].row);
                    ...
                    else
                    {
                        lulcdat[dyr][ichrt].col =
                            lulcdat[telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1][ichrt].col;
                        lulcdat[dyr][ichrt].row =
                            lulcdat[telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1][ichrt].row;
                        lulcdat[dyr][ichrt].varname =
                            lulcdat[telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1][ichrt].varname;
                        lulcdat[dyr][ichrt].year =
                            telmnt[0].lcluc.lastyr + (dyr - (telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1));
                        lulcdat[dyr][ichrt].icohort =
                            lulcdat[telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1][ichrt].icohort;
                        lulcdat[dyr][ichrt].isrccohort =
                            lulcdat[telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1][ichrt].isrccohort;
                        lulcdat[dyr][ichrt].standage =
                            lulcdat[telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1][ichrt].standage;
                        lulcdat[dyr][ichrt].chrtarea =
                            lulcdat[telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1][ichrt].chrtarea;
                        lulcdat[dyr][ichrt].potveg =
                            lulcdat[telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1][ichrt].potveg;
                        lulcdat[dyr][ichrt].currentveg =
                            lulcdat[telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1][ichrt].currentveg;
                        lulcdat[dyr][ichrt].subtype =
                            lulcdat[telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1][ichrt].subtype;
                        lulcdat[dyr][ichrt].agstate =
                            lulcdat[telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1][ichrt].agstate;
                        lulcdat[dyr][ichrt].agprevstate =
                            lulcdat[telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1][ichrt].agprevstate;
                        lulcdat[dyr][ichrt].tillflag =
                            lulcdat[telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1][ichrt].tillflag;
                        lulcdat[dyr][ichrt].fertflag =
                            lulcdat[telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1][ichrt].fertflag;
                        lulcdat[dyr][ichrt].irrgflag =
                            lulcdat[telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1][ichrt].irrgflag;
                        lulcdat[dyr][ichrt].disturbflag =
                            lulcdat[telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1][ichrt].disturbflag;
                        lulcdat[dyr][ichrt].disturbmonth =
                            lulcdat[telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1][ichrt].disturbmonth;
                        lulcdat[dyr][ichrt].FRI =
                            lulcdat[telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1][ichrt].FRI;
                        lulcdat[dyr][ichrt].slashpar =
                            lulcdat[telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1][ichrt].slashpar;
                        lulcdat[dyr][ichrt].vconvert =
                            lulcdat[telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1][ichrt].vconvert;
                        lulcdat[dyr][ichrt].prod10par =
                            lulcdat[telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1][ichrt].prod10par;
                        lulcdat[dyr][ichrt].prod100par =
                            lulcdat[telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1][ichrt].prod100par;
                        lulcdat[dyr][ichrt].vrespar =
                            lulcdat[telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1][ichrt].vrespar;
                        lulcdat[dyr][ichrt].sconvert =
                            lulcdat[telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1][ichrt].sconvert;
                        lulcdat[dyr][ichrt].region =
                            lulcdat[telmnt[0].lcluc.lastyr - telmnt[0].clm.startyr + 1][ichrt].region;
                    }
                }
            }
        }
        else // 0 == telmnt[0].lcluc.tlulcflag
        {
            for (ichrt = 0; ichrt < mxcohrtdat[0].total; ++ichrt)
            {
                ...
                fatalerr = telmnt[0].coregerr(flog1, "Climate", telmnt[0].col, telmnt[0].row, "LULC",
                                              lulcdat[0][ichrt].col, lulcdat[0][ichrt].row);
...
//  Pass disturbance information to telmnt[0]
    ...
    for (ichrt = 0; ichrt < telmnt[0].maxcohorts; ++ichrt)
    {
        ...
        if (pdyr > 1 && pdyr < (totsptime + 2) && istateflag < 2 && 1 == telmnt[0].cohort[ichrt].agstate &&
            1 == telmnt[0].cohort[ichrt].agprvstate)
        {
            telmnt[0].prvmxcohrts = mxcohrtdat[tstyr].total;
        }
        ...
        //   cout << "subtype = " << ichrt << " " << lulcdat[tstyr][ichrt].subtype << " " <<
        //   lulcdat[tstyr][ichrt].currentveg << " " << telmnt[0].cohort[ichrt].cmnt << endl; cout << "subtype = " <<
        //   ichrt << " " <<  telmnt[0].cohort[ichrt].cmnt << endl;
        //
        //  Buggy code  BSF Add to allow pasture or cropland equilibration
        //
        // if(telmnt[0].lcluc.getCommunityType( lulcdat[tstyr][ichrt].currentveg == 50 ||
        // telmnt[0].lcluc.getCommunityType( lulcdat[tstyr][ichrt].currentveg == 51)))
...
void updateTTEMGridCell(const int &pdyr, ofstream &rflog1)
{
    int dm;
    ...
    ************************************************************* */
    ...
    {
        for (ichrt = telmnt[0].prvmxcohrts; ichrt < telmnt[0].maxcohorts; ++ichrt)
        {
            tchrt = telmnt[0].cohort[ichrt].srcCohort - 1;

            telmnt[0].setCohortTEMState(telmnt[0].cohort[tchrt], telmnt[0].cohort[ichrt]);
        }
    }
    ...
    ************************************************************* */
    ...
    for (ichrt = 0; ichrt < telmnt[0].maxcohorts; ++ichrt)
    {
        ...
        // cout << "cohort = " << ichrt << " " << telmnt[0].cohort[ichrt].cmnt << " " << telmnt[0].cohort[ichrt].agcmnt
        // << endl;
        telmnt[0].tem.veg.cmnt = telmnt[0].cohort[ichrt].cmnt;

        //  cout << "cohort = " << ichrt << " " <<  telmnt[0].tem.veg.cmnt <<  " " << telmnt[0].cohort[ichrt].tqc <<
        //  endl;

        // Determine soil characteristics for cohort

        telmnt[0].tem.soil.xtext(telmnt[0].tem.veg.cmnt, telmnt[0].tem.soil.getPCTSILT(),
        ...
        for (dm = 0; dm < CYCLE; ++dm)
        {
            //      cout << "dm = " << dm << endl;
            // Run TEM
            telmnt[0].updateTEMmonth(equil, totsptime, pdyr, dm, ichrt, rflog1);
        ...
        //     cout << "temwritepred = " << pdyr << " " << telmnt[0].tem.totyr << " " << telmnt[0].tem.startyr << " " <<
        //     telmnt[0].tem.endyr << " " << telmnt[0].tem.startyr-spinoutyrs << " " <<
        //     telmnt[0].wrtyr%telmnt[0].tem.diffyr << " " << spinoutfg << endl;

        if ((1 == spinoutfg && telmnt[0].tem.totyr < telmnt[0].tem.startyr) ||
            (2 == spinoutfg && telmnt[0].tem.totyr >= (telmnt[0].tem.startyr - spinoutyrs)) ||
            (telmnt[0].tem.totyr >= telmnt[0].tem.startyr && telmnt[0].tem.totyr <= telmnt[0].tem.endyr) &&
                0 == (telmnt[0].wrtyr % telmnt[0].tem.diffyr))
        {

            // Output TEM transient results for specified years to files

            telmnt[0].temwritepred(ftempred, tempredmap, pdyr, ichrt, telmnt[0].ntempred, spinoutfg, 1);
        }
