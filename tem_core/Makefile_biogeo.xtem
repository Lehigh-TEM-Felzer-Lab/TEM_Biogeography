CXX = g++
CFLAGS = -O2 -msse2 -mcmodel=medium

CLMOBJ = tclm45_ndep.o  
LULCOBJ = tbiome45.o tlcluc45a.o tdisturb.o
TEMOBJ = ttem45_biogeo.o atms45_ndep.o penmon45_equil.o tveg45_equil.o tmcrb45_lulc.o \
         tsoil45_lulc.o humnact45_cwd.o
ELMNTOBJ = elmnt45.o telm45_disturb.o latdat45.o tclmdat45.o tco2dat45.o \
           lulcdat45a.o tmaxcohortdat45.o ttemdat45a.o telvdat45.o tsoldat45.o disturbdat.o \
           atmdepdat.o tatmdep.o
OBJ = tprocessXML45.o

xtem45_biogeo: ${CLMOBJ} ${LULCOBJ} ${TEMOBJ} ${ELMNTOBJ} ${OBJ} xtem45_disturb.cpp 
	${CXX} ${CFLAGS} -o xtem45_biogeo ${CLMOBJ} ${LULCOBJ} ${TEMOBJ} ${ELMNTOBJ} ${OBJ} xtem45_disturb.cpp
...
ttem45_biogeo.o: ttem45_biogeo.cpp ttem45_disturb.h
	${CXX} ${CFLAGS} -c ttem45_biogeo.cpp
