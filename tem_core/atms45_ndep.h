...
class Atms45
{
  ...
  public:
    ...
    ************************************************************* */
    ...
    //
    double daylength(const float &lat, const int &dm);

    double lwrad(const double &tair, const double &vpr, const double &nirr, const double &girr);
    ...
    void petjh(const double &nirr, const double &tair, const int &pdm);

    // Determine in precipitation occurs as rain or snow

    void precsplt(const double &prec, const double &tair, double &rain, double &snowfall);
    ...
    inline double getCO2(void)
    {
        return co2;
    }

    inline void setCO2(const double &pco2)
    {
        co2 = pco2;
    }
    ...
    inline double getCO2LEVEL(void)
    {
        return co2level;
    }
    ...
    inline double getNIRR(void)
    {
        return nirr;
    }
    inline double getNIRRN(void)
    {
        return nirrn;
    }
    ...
    inline double getPAR(void)
    {
        return par;
    }

    inline void setPAR(const double &ppar)
    {
        par = ppar;
    }
    ...
    inline double getPREV2TAIR(void)
    {
        return prev2tair;
    }
    ...
    inline double getPREVTAIR(void)
    {
        return prevtair;
    }
    ...
    inline double getSNOWFALL(void)
    {
        return snowfall;
    }
