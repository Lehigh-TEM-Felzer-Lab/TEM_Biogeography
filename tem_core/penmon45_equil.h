...

{
  ...
  public:
    ...
    ************************************************************** */
    ...
    double gcpet(const int &pdcmnt, const int &dm, const double &lai, const double &gpp, const double &rcanmm,
                 const double &vpr, const double &vpd, const double &co2, const double &pdayl);

    void hydraulics(const int &pdcmnt, const int &phen, const double &lai, const double &psla, const double &stemc,
                    const double &rootc, const double &availh2o, const double &awcapmm, const double &prec);

    void getecd(const string &ecd);

    double shuttlewallace(const int &pdcmnt, const double &nirr, const double &lwout, const double &lai,
    ...
    double actevap(const int &pdcmnt, const double &nirr, const double &lwout, const double &lai, const double &tmean,
                   const double &vpd, const int &dm, const double &gc, const double &snowcover, const double &etimes,
                   const double &precip, const double &esoilmmmo, const double &elev);

    double potevap(const int &pdcmnt, const double &nirr, const double &lwout, const double &lai, const double &tmean,
                   const double &vpd, const int &dm, const double &gc, const double &snowcover, const double &etimes,
                   const double &precip, const double &esoilmmmo, const double &elev);

    double watev(const double &nirr, const double &lwout, const double &tmean, const double &vpd, const double &wind,
                 const double &rrun, const double &rsun, const int &dm);
    ...
    inline void setALBEDO(const double &palbedo, const int &pcmnt)
    {
    ...
    inline void setCDLEAF(const double &pcdleaf, const int &pcmnt)
    {
    ...
    inline void setWLEAF(const double &pwleaf, const int &pcmnt)
    {
        wleaf[pcmnt] = pwleaf;
    };
    ...
    inline void setGSA(const double &pgsa, const int &pcmnt)
    {
        gsa[pcmnt] = pgsa;
    };
    ...
    inline void setGSMIN(const double &pgsmin, const int &pcmnt)
    {
        gsmin[pcmnt] = pgsmin;
    };
    ...
    inline void setKEXT(const double &pkext, const int &pcmnt)
    {
        kext[pcmnt] = pkext;
    };
    ...
    inline void setLSCMIN(const double &plscmin, const int &pcmnt)
    {
    ...
    inline void setGROOT(const double &pgroot, const int &pcmnt)
    {
        groot[pcmnt] = pgroot;
    };
    ...
    inline void setKSTEM(const double &pkstem, const int &pcmnt)
    {
        kstem[pcmnt] = pkstem;
    };
    ...
    inline void setRHOSTEM(const double &prhostem, const int &pcmnt)
    {
  ...
  private:
    ...
    ************************************************************** */
    ...
    double beta; // slope of the saturation vapour pressure function, (kPa C-1)
    double ndays[CYCLE];

    double CPAIR;
    double DAYtoS;
    double LAMBDA; // latent heat of vaporization of water, J kg^-1
    double PSY;    // psychrometer constant,(kPa C-1)
    double RHOAIR;
    double CO2REF;
    double SCALEH;
    ...
    double ptalpha; // priestly-taylor coefficient
