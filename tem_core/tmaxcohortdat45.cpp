...
int MaxCohortdat45::getdel(FILE *infile)
{
    ...
    chrtend = fscanf(infile, "%f,%f, %s ,%ld,%d,%d,%d, %s", &col, &row, tmpvarname, &carea, &year, &total, &natchrts,
                     tmpcontnent);
...
void MaxCohortdat45::out(ofstream &ofile, const float &col, const float &row, const string &varname, const long &carea,
                         const int &year, const int &total, const int &natchrts, const string &contnent)
{
...
void MaxCohortdat45::outdel(ofstream &ofile, const float &col, const float &row, const string &varname,
                            const long &carea, const int &year, const int &total, const int &natchrts,
