...
/* **************************************************************
************************************************************** */
double Atms45::lwrad(const double &tair, const double &vpr, const double &nirr, const double &girr)
...
void Atms45::petjh(const double &nirr, const double &tair, const int &pdm)
{
...
void Atms45::precsplt(const double &prec, const double &tair, double &rain, double &snowfall)
{
