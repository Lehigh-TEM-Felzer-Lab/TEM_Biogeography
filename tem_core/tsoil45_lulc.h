...
class Tsoil45 : public ProcessXML45
{
  ...
  public:
    ...
    ************************************************************** */
    ...
    void lake(const double &tair, const double &prec, double &rain, double &snowfall, const double &pet, double &eet);

    void resetMonthlyFluxes(void);

    void resetYrFluxes(void);

    void setKH2O(const double &vsm, const int &moistlim);
    ...
    void updateHydrology(const double &elev, const double &tair, const double &prevtair, const double &prev2tair,
                         const double &rain, const double &pet, const double &avlh2o, const double &rgrndh2o,
                         const double &sgrndh2o, const int &irrgflag, double &irrigate, const int &pdm);

    void updateDOCLEACH(const double &doc, const double &sh2o);

    void updateNLosses(const int &pdcmnt, const double &h2oloss, const double &availn, const double &soilh2o);

    double updateRootZ(const int &pdcmnt, const double &sh2o, const double &finerootc);

    void xtext(const int &pdcmnt, const double &pctsilt, const double &pctclay);

    // "Get" and "Set" private variables and parameters

    // availn *************************************************

    inline double getAVLN(void)
    {
        return availn;
    }
    ...
    inline double getDRAINAGE(void)
    {
        return drainage;
    }
    ...
    inline void setMINROOTZ(const double &pminrootz, const int &pcmnt)
    {
    ...
    inline void setZ0(const double &pz0, const int &pcmnt)
    {
        z0[pcmnt] = pz0;
    }
    ...
    inline void setNLOSS(const double &pnloss, const int &pcmnt)
    {
        nloss[pcmnt] = pnloss;
    }
    ...
    inline void setDENITR(const double &pdenitr, const int &pcmnt)
    {
    ...
    inline double getPCTFLDCAP(void)
    {
        return pcfldcap;
    }
    ...
    inline double getPCTWILTPT(void)
    {
        return pcwiltpt;
    }
    ...
    inline double getPREVSPACK(void)
    {
        return prevspack;
    }
    ...
    inline double getPSIPLUSC(void)
    {
        return psiplusc;
    }
    ...
    inline void setROOTZA(const double &prootza, const int &pcmnt)
    {
    ...
    inline void setROOTZB(const double &prootzb, const int &pcmnt)
    {
    ...
    inline void setROOTZC(const double &prootzc, const int &pcmnt)
    {
    ...
    inline double getSNOWPACK(void)
    {
        return snowpack;
    }
