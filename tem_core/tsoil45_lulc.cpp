...
void Tsoil45::getrootz(const string &ecd)
{
    ...
    for (dcmnt = 1; dcmnt < MAXCMNT; ++dcmnt)
    {
        ...
        rootzc[comtype] = getXMLcmntArrayDouble(infile, "rootzECD", "rootzc", comtype);

        minrootz[comtype] = getXMLcmntArrayDouble(infile, "rootzECD", "minrootz", comtype);
...
void Tsoil45::lake(const double &tair, const double &prec, double &rain, double &snowfall, const double &pet,
                   double &eet)
{
...
void Tsoil45::setSWP(void)
{
    ...
    pota = 100.0 *
           exp(-4.396 - 0.0715 * pctclay - 0.000488 * pctsand * pctsand - 0.00004285 * pctsand * pctsand * pctclay);

    potb = -3.14 - 0.00222 * pctclay * pctclay - 0.00003484 * pctsand * pctsand * pctclay;
...
void Tsoil45::setKH2O(const double &vsm, const int &moistlim)
{
    double vfc;
...
double Tsoil45::snowmelt(const double &elev, const double &tair, const double &prevtair, const double &psnowpack)
{
...
double Tsoil45::srunoff(const double &elev, const double &tair, const double &prevtair, const double &prev2tair,
...
void Tsoil45::updateHydrology(const double &elev, const double &tair, const double &prevtair, const double &prev2tair,
                              ...
                              const double &sgrndh2o, const int &irrgflag, double &irrigate, const int &pdm)
{
    ...
    srun = srunoff(elev, tair, prevtair, prev2tair, sgrndh2o);
};

/* *************************************************************
************************************************************* */
void Tsoil45::updateDOCLEACH(const double &doc, const double &sh2o)
...
void Tsoil45::updateNLosses(const int &pdcmnt, const double &h2oloss, const double &availn, const double &soilh2o)
{
...
double Tsoil45::updateRootZ(const int &pdcmnt, const double &sh2o, const double &finerootc)

{
    ...
    // cout << "Available Water Cap : " << awcapmm << endl;
...
void Tsoil45::xtext(const int &pdcmnt, const double &pctsilt, const double &pctclay)
{
