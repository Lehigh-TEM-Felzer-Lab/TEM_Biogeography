...
//  Pass disturbance information to telmnt[0]
    ...
    for (ichrt = 0; ichrt < telmnt[0].maxcohorts; ++ichrt)
    {
        ...
        //    cout << "lulc type = " << ichrt << " " << " " << telmnt[0].cohort[ichrt].cmnt << " " <<
        //    telmnt[0].cohort[ichrt].agcmnt << " " << lulcdat[tstyr][ichrt].agstate << endl;
    }
};
...
void updateTTEMGridCell(const int &pdyr, ofstream &rflog1)
{
    ...
    ************************************************************* */
    ...
    for (ichrt = 0; ichrt < telmnt[0].maxcohorts; ++ichrt)
    {
        ...
        //  cout << "cohort_here = " << ichrt << " " << telmnt[0].cohort[ichrt].cmnt << " " <<
        //  telmnt[0].cohort[ichrt].agcmnt  << endl;
