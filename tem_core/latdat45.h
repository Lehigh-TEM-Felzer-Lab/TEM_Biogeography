...
class Latdat45
{
  ...
  public:
    ...
    ************************************************************** */
    ...
    void out(ofstream &ofile, const float &col, const float &row, const string &varname, const double &lat,
             const double &lon, const string &contnent);

    void outdel(ofstream &ofile, const float &col, const float &row, const string &varname, const double &lat,
                const double &lon, const string &contnent);
