...
double Tclm45::mkclds(const double &girr, const double &nirr)
{
...
double Tclm45::mkd40(const double &lon, const double &lat, const string &contnent, const double &o3, const int &pdm)
{
    int k;
    int itmp;
    double d40;
...
double Tclm45::xgirr(const float &plat, const int &pdm, double &psumday)
{
