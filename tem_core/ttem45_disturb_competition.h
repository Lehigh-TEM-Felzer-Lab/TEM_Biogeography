...
class Ttem45
{
  ...
  public:
    ...
    ************************************************************** */
    ...
    void ECDsetODEstate(const int &pdcmnt, const double &psiplusc);
    ...
    int monthlyTransient(const int &outyr, const int &pdm, const double &outtol, const int &ichrt, ofstream &flog1);
    ...
    void setELMNTecd(const int &pdcmnt, const double &psiplusc);

    void setEquilC2N(const int &pdcmnt, const double &co2);

    void setPrevState(void);

    int stepmonth(const int &pdyr, const int &pdm, int &intflag, const double &ptol, const int &icohort,
                  ofstream &flog1);

    int testEquilibrium(const int &pdyr, const int &pichrt, const int &nyears, const double &vegceq,
    ...
    inline void setAVLNB(const double &pavlnb, const int &pcmnt)
    {
        avlnb[pcmnt] = pavlnb;
    }
    ...
    inline void setNMAX_GROW(const double &pnmax_grow, const int &pchrt)
    {
    ...
    inline double getPREVY(const int &i, const int &j)
    {
        return prevy[i][j];
    }
    ...
    inline void setSOLCB(const double &psolcb, const int &pcmnt)
    {
        solcb[pcmnt] = psolcb;
    }
    ...
    inline void setSOLNB(const double &psolnb, const int &pcmnt)
    {
        solnb[pcmnt] = psolnb;
    }
    ...
    inline void setLEAFNB(const double &pleafnb, const int &pcmnt)
    {
    ...
    inline void setSAPWOODNB(const double &psapwoodnb, const int &pcmnt)
    {
    ...
    inline void setHEARTWOODNB(const double &pheartwoodnb, const int &pcmnt)
    {
    ...
    inline void setROOTNB(const double &prootnb, const int &pcmnt)
    {
    ...
    inline void setLABILENB(const double &plabilenb, const int &pcmnt)
    {
    ...
    inline void setSEEDNB(const double &pseednb, const int &pcmnt)
    {
    ...
    inline void setLEAFCB(const double &pleafcb, const int &pcmnt)
    {
    ...
    inline void setSAPWOODCB(const double &psapwoodcb, const int &pcmnt)
    {
    ...
    inline void setHEARTWOODCB(const double &pheartwoodcb, const int &pcmnt)
    {
    ...
    inline void setROOTCB(const double &prootcb, const int &pcmnt)
    {
    ...
    inline void setLABILECB(const double &plabilecb, const int &pcmnt)
    {
    ...
    inline void setSEEDCB(const double &pseedcb, const int &pcmnt)
    {
    ...
    inline double getY(const int &i, const int &j)
    {
        return y[i][j];
    }
  ...
  private:
    ...
    ************************************************************** */
    ...
    int adapt(const int &numeq, double pstate[], const double &ptol, const int &pdm, const int &pdyr,
              const double &nmax_grow);

    int boundcon(double ptstate[], double err[], const double &ptol);

    void delta(const int &dm, const int &pdyr, const double &nmax_grow, double pstate[], double pdstate[]);
    ...
    void pcdisplayMonth(const int &dyr, const int &dm);
    ...
    void rkbs(const int &numeq, double pstate[], double &pdt, const int &pdm, const int &pdyr, const double &nmax_grow);

    void rkf(const int &numeq, double pstate[], double &pdt, const int &pdm, const int &pdyr, const double &nmax_grow);
