...
int ProcessXML45::getXMLcommunityNode(ifstream &infile, const string &rootnode)
...
double ProcessXML45::getXMLcmntArrayDouble(ifstream &infile, const string &rootnode, const string &varnode,
                                           const int &index)
...
int ProcessXML45::getXMLcmntArrayInt(ifstream &infile, const string &rootnode, const string &varnode, const int &index)
{
    string line;
    string value;
...
long ProcessXML45::getXMLcmntArrayLong(ifstream &infile, const string &rootnode, const string &varnode,
                                       const int &index)
{
    string line;
    string value;
...
double ProcessXML45::getXMLdouble(ifstream &infile, const string &rootnode, const string &varnode)
{
    string line;
    string value;
...
int ProcessXML45::getXMLint(ifstream &infile, const string &rootnode, const string &varnode)
{
    string line;
    string value;
...
long ProcessXML45::getXMLlong(ifstream &infile, const string &rootnode, const string &varnode)
{
    string line;
    string value;
...
int ProcessXML45::getXMLrootNode(ifstream &infile, const string &rootnode)
...
int ProcessXML45::getXMLsiteCommunityNode(ifstream &infile, const string &rootnode, string &description)
...
int ProcessXML45::getXMLsiteRootNode(ifstream &infile, const string &rootnode, string &version, string &sitename,
                                     string &sitecol, string &siterow, string &developer, string &updated)
{
...
string ProcessXML45::getXMLstring(ifstream &infile, const string &rootnode, const string &varnode)
{
    string line;
    string value;
...
int ProcessXML45::getXMLtemvegNode(ifstream &infile, const string &rootnode)
{
    string line;
    string value;
...
double ProcessXML45::getXMLtvegArrayDouble(ifstream &infile, const string &rootnode, const string &varnode,
                                           const int &index)
...
int ProcessXML45::getXMLtvegArrayInt(ifstream &infile, const string &rootnode, const string &varnode, const int &index)
{
    string line;
    string value;
