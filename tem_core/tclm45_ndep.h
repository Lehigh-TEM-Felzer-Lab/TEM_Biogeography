...
class Tclm45 : public Atms45
{
  ...
  public:
    ...
    ************************************************************* */
    ...
    double mkd40(const double &lon, const double &lat, const string &contnent, const double &o3, const int &pdm);
    ...
    double xgirr(const float &plat, const int &pdm, double &psumday);
