...
int Latdat45::getdel(FILE *infile)
{
    ...
    latend = fscanf(infile, "%f,%f, %s ,%lf,%lf, %s", &col, &row, tmpvarname, &lat, &lon, tmpcontnent);
...
void Latdat45::out(ofstream &ofile, const float &col, const float &row, const string &varname, const double &lat,
                   const double &lon, const string &contnent)
{
...
void Latdat45::outdel(ofstream &ofile, const float &col, const float &row, const string &varname, const double &lat,
                      const double &lon, const string &contnent)
{
